...
import { MessageCircle, Sparkles, Phone, Brain, Palette, Sun, Moon } from 'lucide-react';
...
const MobileSettings = () => {
  ...
  return (
    <div className="h-full bg-white dark:bg-gray-900 overflow-y-auto" dir="rtl">
      {/* Header */}
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 sticky top-0 z-10">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">הגדרות</h1>
      </div>
      ...
      <div className="p-6">
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-100 dark:border-green-800/50">
            <div className="flex items-center gap-3 mb-4">
              <MessageCircle className="w-6 h-6 text-green-600 dark:text-green-400" />
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">חיבור ל-WhatsApp</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2" dir="ltr">
                  ...
                  <div className="flex items-center px-3 py-3 rounded-lg border border-green-200 dark:border-green-700 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium">
                  ...
                  <select
                    ...
                    className="px-4 py-3 rounded-lg border border-green-200 dark:border-green-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-transparent font-medium"
                  >
                  ...
                  <input
                    ...
                    maxLength={7}
                    className="flex-1 px-4 py-3 rounded-lg border border-green-200 dark:border-green-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl p-6 border border-blue-100 dark:border-blue-800/50">
            <div className="flex items-center gap-3 mb-4">
              <Palette className="w-6 h-6 text-blue-600 dark:text-blue-400" />
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">ערכת צבעים</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* Light Mode */}
                <button
                  onClick={() => skinName === 'dark' && toggleTheme()}
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      skinName === 'light' ? 'bg-blue-500' : 'bg-gray-200'
                    }`}>
                      <Sun className={`w-6 h-6 ${
                        skinName === 'light' ? 'text-white' : 'text-gray-600'
                      }`} />
                    </div>
                    <span className={`text-sm font-semibold ${
                      skinName === 'light' ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      מצב בהיר
                    </span>
                    {skinName === 'light' && (
                      <span className="text-xs text-blue-600 font-medium">✓ פעיל</span>
                    )}
                  </div>
                </button>
                ...
                {/* Dark Mode */}
                <button
                  onClick={() => skinName === 'light' && toggleTheme()}
                  className={`p-4 rounded-xl border-2 transition-all transform active:scale-95 ${
                    skinName === 'dark'
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                      skinName === 'dark' ? 'bg-blue-500' : 'bg-gray-200'
                    }`}>
                      <Moon className={`w-6 h-6 ${
                        skinName === 'dark' ? 'text-white' : 'text-gray-600'
                      }`} />
                    </div>
                    <span className={`text-sm font-semibold ${
                      skinName === 'dark' ? 'text-white' : 'text-gray-700'
                    }`}>
                      מצב כהה
                    </span>
                    {skinName === 'dark' && (
                      <span className="text-xs text-blue-400 font-medium">✓ פעיל</span>
                    )}
                  </div>
                </button>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 text-xs text-gray-600 dark:text-gray-400">
                <p>💡 המצב שתבחר ישמר אוטומטית ויחול על כל האפליקציה</p>
              </div>
            </div>
          </div>

          {/* AI Model Selection Section */}
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-purple-100 dark:border-purple-800/50">
            <div className="flex items-center gap-3 mb-4">
              <Sparkles className="w-6 h-6 text-purple-600 dark:text-purple-400" />
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">בחירת מודל AI</h2>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-purple-200 dark:border-purple-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
                  {models.length === 0 ? (
              ...
              <div className="border-t border-purple-200 dark:border-purple-800 pt-4">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">הגדרות API</h3>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
                  </div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-6 border border-indigo-100 dark:border-indigo-800/50">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">זיכרון המשפחה</h2>
            </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">אודות</h2>
